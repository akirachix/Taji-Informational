            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-lg md:text-xl lg:text-2xl">
                    ...
                    <div className="flex justify-center md:justify-start mb-4 md:mb-0">
                        <img src="/images/logo.png" alt="Logo" className="w-full h-10" />
                    </div>
                    ...
                    <div className="text-center md:text-left font-Darker Grotesque md:text-2xl md:leading-10">
                    ...
                    <div className="text-center md:text-left md:text-2xl mr-2 mb-12 font-Darker Grotesque md:leading-10">
